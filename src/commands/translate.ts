...
{{Пассивный|[число] Навык|Ультимейт|Атрибуты|Базовая Атака}} - {{Усиление|Ослабление|Изменение}}
...
- Если одно и то же умение имеет несколько изменений, указывай каждое отдельным пунктом.
